...
enum LogicTests {
    static func main() {
        ...
        check("isNewer true", Versioning.isNewer("1.0.13", than: "1.0.12"))
        check("isNewer equal", !Versioning.isNewer("1.0.13", than: "1.0.13"))
        check("isNewer false", !Versioning.isNewer("1.0.12", than: "1.0.13"))
